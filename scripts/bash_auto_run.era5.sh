...
prsdwnstartdatetime=202204060000		## start datetime for downloading pressure level forcing data
prsdwnenddatetime=202204170000  		## Note: at least more than 6 days ahead of prsdwnstartdatetime, to avoid ungrib error
sfcdwnstartdatetime=202204060000		## Start datetime for downloading surface forcing dataset
sfcdwnenddatetime=202204170000			## End datatime for downloading surface forcing dataset
...
prsungrbstartdatetime=2022-04-06_00:00:00  	## Note: make sure its thesame as 'prsdwnstartdatetime' and formatted as it is (using '_' and ':" as date and time separator) to avoid ungrib error
prsungrbenddatetime=2022-04-16_00:00:00		## Note: at most the end datetime should be 18 hrs less than 'prsdwnenddatetime'
sfcungrbstartdatetime=2022-04-06_00:00:00	## Note: Should be less than or equal to 'prsungrbstartdatetime'
sfcungrbenddatetime=2022-04-17_00:00:00		## Note: at most, it should be less than or equal to 'sfcdwnenddatetime'
...
simstartdate=2022-04-07_06:00:00		## Note: Should be thesame as the 'prsungrbstartdatetime'
simenddate=2022-04-16_00:00:00			## Can be any datetime you want the simulation to stop

rundir="era5_60km_uniform"			## Name of the model directory to create or over write. Note model excutables, files and output will be copied to this directory
...
ncores=384					## How many processors do which to use. Note: make sure a partitioning file for the number processors you have choosen is avaialable in the 'meshdir'
LOGFILE="log.era5_auto_60km"		## This bash script generates a log file. What do you wish to name the logfile?
