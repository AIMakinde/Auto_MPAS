...
prsstartdate=202204050000
prsenddate=202204100000
sfcstartdate=202204050000
sfcenddate=202204200000
tstep=1
singlemultiyears=1
...
#	python -u era5_dwn_prslev.py --start_time=${prssub1} --end_time=${prssub2} --time_step=${tstep} --format=netcdf
	# prssub1="01010000"
	echo "Done."
...
#*****************************************************************************************************
	...
	python -u era5_dwn_sfc.py --start_time=${sfcsub1} --end_time=${sfcsub2} --time_step=${tstep} --format=netcdf
	echo "Done."
