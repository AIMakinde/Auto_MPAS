...
filename="latlon_mpas6015km_aug1986.nc"
prfx1="6015"
prfx2="1986"
prfx3="aug"
clnd="1986-07-15,00:00:00,6hour"
...
do
  ...
  then
      ...
      cdo chname,surface_pressure,pas -selvar,surface_pressure ${filename} "pas_mpas${prfx1}_${prfx2}.nc"
