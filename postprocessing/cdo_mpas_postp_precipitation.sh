...
filename="latlon_mpas60km_1985-2014.nc"
prfx1="60"
prfx2="1985-2014"
prfx3="mon"
outcalender="1985-01-01,00:00:00,3hours"
...
# set calendar
cdo -setcalendar,standard -settaxis,${outcalender}  prc_mpas${prfx1}_${prfx2}.nc prc_mpas${prfx1}_${prfx3}_${prfx2}.nc
