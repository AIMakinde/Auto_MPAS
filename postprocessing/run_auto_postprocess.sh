...
basedir=/mnt/lustre/users/amakinde/sims/mpas/agulhas_3km_exp
ppscriptdir=/mnt/lustre/users/amakinde/sims/mpas/agulhas_3km_exp/postprocscripts
cd ${basedir}
...
do
    ...
    do
	    ...
	    cp ${ppscriptdir}/cdo_mpas_postp_variables.sh ${simdir}_sim/${ensdir}/mpas_atmos/2022/
        cp ${ppscriptdir}/cdo_mpas_postp_precipitation.sh ${simdir}_sim/${ensdir}/mpas_atmos/2022/
        cp ${ppscriptdir}/cdo_mpas_postp_geop.sh ${simdir}_sim/${ensdir}/mpas_atmos/2022/
        cp ${ppscriptdir}/cdo_mpas_postp_EQPT.sh ${simdir}_sim/${ensdir}/mpas_atmos/2022/
        cp ${ppscriptdir}/bash_postproces.sh ${simdir}_sim/${ensdir}/mpas_atmos/2022/
        cp ${ppscriptdir}/prep_data_mpas.sh ${simdir}_sim/${ensdir}/mpas_atmos/2022/
        cp ${ppscriptdir}/*.txt ${simdir}_sim/${ensdir}/mpas_atmos/2022/
        cp ${ppscriptdir}/include_fields_${includeprfx} ${simdir}_sim/${ensdir}/mpas_atmos/2022/include_fields
        cp ${ppscriptdir}/target_domain_${includeprfx} ${simdir}_sim/${ensdir}/mpas_atmos/2022/target_domain
        cp setupMPAS ${simdir}_sim/${ensdir}/mpas_atmos/2022/
        ln -sf ${basedir}/meshes/${includeprfx}/regrid_sa/${gridfname} ${simdir}_sim/${ensdir}/mpas_atmos/2022/
